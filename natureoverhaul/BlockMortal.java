...
/**
 * Specifies a block which is mortal and can die (not in the sense of sentient,
 * but the sense of is not forever like most blocks)
 * 
...
public abstract class BlockMortal extends Block implements IBlockDeath {
	...
	/**
	 * The action to take upon death Example:Block changes to air
	 * 
	 * @param world
	 * @param i
	 * @param j
	...
	/**
	 * Return's max radii of other nearby plants Do not use a radius above 5, if
	 * you want to, overload hasStarved 5 * 5 * 5 = 125, that's a lot of blocks
	 * to check Return 0 to skip this check
	 * 
	 * @param world
	 * @param i
	 * @param j
